...
## 项目目标
编写一份 Neural Processing Unit 设计的由浅入深，包含芯片前后端设计的教程markdown，要包含大量的习题和参考答案（答案默认折叠）。
...
- 项目状态：正在转换为纯Markdown格式，移除HTML依赖

## 待办事项
- [x] 移除项目中的.js和.css文件（已完成）
- [ ] 更新CLAUDE.md以反映Markdown结构（进行中）
- [ ] 创建HTML到Markdown转换脚本
- [ ] 将所有章节HTML文件转换为Markdown
- [ ] 逐章节清理转换后的Markdown文件
- [ ] 验证所有章节转换正确
...
1. 打开 `index.md` 开始浏览教程

### 技术特性

- **模块化结构**：每章独立文件，易于维护和更新
- **纯Markdown格式**：无需浏览器，支持任何Markdown阅读器
- **语法高亮**：支持Verilog、Python等代码高亮
- **可折叠答案**：练习题答案使用details标签实现折叠
- **离线可用**：无外部依赖，完全自包含
